...
namespace RitsuLibModTemplate;

[ModInitializer(nameof(Initialize))]
public partial class Entry
{
    // ModId 需要和 RitsuLibModTemplate.json 里的 id 保持一致。
    // res://RitsuLibModTemplate/... 里的 RitsuLibModTemplate 是 PCK 资源目录，不是 C# namespace。
    public const string ModId = "RitsuLibModTemplate";
    ...
    public static void Initialize()
    {
        ...
        Logger.Info("RitsuLibModTemplate initialized.");
    }
}
